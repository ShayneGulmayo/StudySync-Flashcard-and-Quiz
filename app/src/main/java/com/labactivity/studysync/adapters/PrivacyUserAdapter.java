...
public class PrivacyUserAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PrivacyUserAdapter(List<User> userList, List<User> selectedUsers, boolean isSelectionList, OnUserSelectedListener listener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getItemViewType() == TYPE_SELECTED) {
            ...
            boolean isOwner = user.getUid().equals(currentUserId);
            ...
            viewHolder.txtRole.setOnClickListener(v -> {
                ...
                popupMenu.setOnMenuItemClickListener(item -> {
                    ...
                    if (item.getItemId() == R.id.remove_access) {
